...
app.controller('myMessageData', ['$scope','$http','$sce',function($scope,$http, $sce) {
    ...
    //删除留言
    $scope.deleteTheMessage=function (w_id) {
        $.ajax({
            method:'POST',
            url:'/message/deleteTheMessage',
            data:{'w_id':w_id},
            dataType: "json",
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded'
