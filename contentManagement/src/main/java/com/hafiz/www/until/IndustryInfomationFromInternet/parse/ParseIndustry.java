package com.hafiz.www.until.IndustryInfomationFromInternet.parse;
...
public class ParseIndustry {
    public List<IndustryInformation> parseContent(List<IndustryInformation> list){
        Document document=null;
        List<IndustryInformation> list_ = new ArrayList<IndustryInformation>();
       /* for(IndustryInformation industryInformation:list){
            try {
                document = Jsoup.connect(industryInformation.getReprintUrl()).userAgent(
